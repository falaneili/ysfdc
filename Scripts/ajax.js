...
function headNavPosition(MARK, SID) {
    var lis;
    if (MARK == "news" && SID != "0001,0002,0003" && SID != "0001,0002,0004" && SID != "0001,0002,0006") {
        if (SID.length > 8) {
    ...
    if (MARK == "help" && SID != "0001,0003,0010") {
...
function helpSelectCurrentPosition(SID) {
    var lis = $(".InpageAddress .p2").find("a");
    for (var i = 0; i < lis.length; ++i) {
